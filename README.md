...
🏃‍♂️ **서울 우먼테크 해커톤 참가 - '지속 가능한 미래도시'를 위한 프로젝트**

## ☝ 개요
#### ❓ `플로깅(Plogging) :: '줍다'라는 뜻의 스웨덴어 plocka upp과 jogging의 합성어. 조깅을 하면서 길가의 쓰레기를 수거하는, 운동과 자연보호활동을 결합한 새로운 활동을 말한다.` <br><br>
> ### ✅ 개발목적
> - 서울 시민의 건강 유지와 더불어 환경 미화 활동을 결합해 지속 가능한 미래도시를 꾸려나갈 수 있는 서비스를 구현한다.
